...
const I18N = (() => {
  ...
  const T = {
    ...
    'Kunde inte återkalla äventyraren': 'Could not recall the adventurer',
    ' har raderats ur valvet.': ' has been deleted from the vault.',
    'Kunde inte radera äventyraren': 'Could not delete the adventurer',
    ...
    'Inga äventyrare vilar här ännu. Skapa en karaktär och spara den till valvet — så överlever den även när äventyret tar slut.': 'No adventurers rest here yet. Create a character and save it to the vault — that way it survives even when the adventure ends.',
    'Kampanj:': 'Campaign:',
    'Tur': 'Turn',
    ...
    'Din äventyrare': 'Your adventurer',
    ...
    '🔄 Slå om ödet': '🔄 Reroll Fate',
    'Återkalla': 'Recall',
    'Valvet — återkalla en sparad äventyrare': 'The Vault — recall a saved adventurer',
    ...
    'Äventyrare som väntar på nästa äventyr': 'Adventurers waiting for their next adventure',
    ...
    'Inga äventyrare vilar här ännu. Skapa en karaktär och spara den till valvet — så öppnas portarna.': 'No adventurers rest here yet. Create a character and save it to the vault — and the gates will open.',
    'Öppnar valvets portar…': 'Opening the vault gates…',
    'Skapa en äventyrare': 'Create an adventurer',
    '✨ Skapa en äventyrare': '✨ Create an Adventurer',
    ...
    'Ingen äventyrare än': 'No adventurer yet',
    // Terminology (W3-P3): 'tur' family is dominant (chat.html 'Din tur'/'Tur', facts/npcs/character t('Tur')). 'vändor' here is only adventure.html:1182 — value kept 'turns' (same EN word); SV-side migration is sibling-owned.
    'vändor': 'turns',
    ...
    // ── Missing-key sweep (2026-08-07): JS-nycklar som läckte svenska i en-läge ──
    'Bakgrundsmodell uppdaterad': 'Background model updated',
    'Inget ännu — Lorekeeper lägger till backstory, drag och förmågor här allt eftersom äventyret utvecklar din karaktär.': 'Nothing yet — Lorekeeper adds backstory, traits and abilities here as the adventure shapes your character.',
    'KRITISK!': 'CRITICAL!',
    'Klass': 'Class',
    'Kunde inte byta Lorekeeper-modell': 'Could not switch Lorekeeper model',
    'Kunde inte byta bakgrundsmodell': 'Could not switch background model',
    'Kunde inte ladda kampanjen — nätverksfel?': 'Could not load the campaign — network error?',
    'Kunde inte ladda transkriptet — nätverksfel?': 'Could not load the transcript — network error?',
    'Kunde inte spara porträttet': 'Could not save the portrait',
    'Lorekeeper uppdaterar världen — tärningen låses upp när jobbet är klart…': 'Lorekeeper is updating the world — the dice unlock when the work is done…',
    'Lorekeeper-modell uppdaterad': 'Lorekeeper model updated',
    'Nämnd i berättelsen': 'Mentioned in the story',
    'Omnämnt flera gånger i berättelsen': 'Mentioned several times in the story',
    'Rank-poäng: hur relevant detta minne är just nu': 'Rank score: how relevant this memory is right now',
    'Senast sedd': 'Last seen',
    'The Adventurer': 'The Adventurer',
    'Tärning': 'Die',
    'Usage': 'Usage',
    'Välj kampanjspråk först!': 'Choose the campaign language first!',
    'flyr från striden!': 'flees from the battle!',
    'missar dig': 'misses you',
    'skada': 'damage',
    'träffar dig': 'hits you',
    'tur': 'turn',
    'öppna journalen': 'open the journal',
    '🎲 Slå tärningen för att fortsätta…': '🎲 Roll the dice to continue…',
