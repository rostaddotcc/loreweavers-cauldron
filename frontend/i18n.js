...
const I18N = (() => {
  ...
  const T = {
    ...
    'Klicka för att byta bild': 'Click to change image',
    'Kampanj: Ett svenskt D&D-äventyr': 'Campaign: A Swedish D&D Adventure',
    ...
    'Mörkrets Rike': 'Realm of Darkness',
    // ── npcs.html filter labels ──
    'Alla': 'All',
    'Allierade': 'Allies',
    'Uppdrag': 'Quests',
    'Fiender': 'Enemies',
    ...
    '⚔️ Ett svenskt D&amp;D-äventyr — Loggbok': '⚔️ A Swedish D&amp;D Adventure — Logbook',
    '📚 Ett svenskt D&amp;D-äventyr — Minnesarkivet': '📚 A Swedish D&amp;D Adventure — The Memory Archive',
    '⚔️ Ett svenskt D&amp;D-äventyr — Gestalter': '⚔️ A Swedish D&amp;D Adventure — Characters',
    '⚔️ Ett svenskt D&amp;D-äventyr — Kartan': '⚔️ A Swedish D&amp;D Adventure — The Map',
    '🏰 Ett svenskt D&amp;D-äventyr — Valvet': '🏰 A Swedish D&amp;D Adventure — The Vault',
